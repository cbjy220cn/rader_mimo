...
% ═══════════════════════════════════════════════════════════════
%  十字阵列系列（每臂2元，总9元，不同间距）
% ═══════════════════════════════════════════════════════════════
cfg_idx = cfg_idx + 1;
array_configs(cfg_idx).name = '十字阵-密集';
array_configs(cfg_idx).create_func = @() create_sparse_cross(2, d_normal);
array_configs(cfg_idx).description = '十字阵(0.5λ间距,9元)';
array_configs(cfg_idx).spacing_ratio = 1.0;
array_configs(cfg_idx).is_sparse = false;

cfg_idx = cfg_idx + 1;
array_configs(cfg_idx).name = '十字阵-1.0λ';
array_configs(cfg_idx).create_func = @() create_sparse_cross(2, lambda * 1.0);
array_configs(cfg_idx).description = '十字阵(1.0λ间距,9元)';
array_configs(cfg_idx).spacing_ratio = 2.0;
array_configs(cfg_idx).is_sparse = true;

cfg_idx = cfg_idx + 1;
array_configs(cfg_idx).name = '十字阵-1.5λ';
array_configs(cfg_idx).create_func = @() create_sparse_cross(2, lambda * 1.5);
array_configs(cfg_idx).description = '十字阵(1.5λ间距,9元)';
...
array_configs(cfg_idx).create_func = @() create_sparse_ura(3, 3, d_normal);
array_configs(cfg_idx).description = 'URA(0.5λ间距,3×3=9元)';
array_configs(cfg_idx).spacing_ratio = 1.0;
array_configs(cfg_idx).is_sparse = false;

cfg_idx = cfg_idx + 1;
array_configs(cfg_idx).name = 'URA-1.0λ';
array_configs(cfg_idx).create_func = @() create_sparse_ura(3, 3, lambda * 1.0);
array_configs(cfg_idx).description = 'URA(1.0λ间距,3×3=9元)';
array_configs(cfg_idx).spacing_ratio = 2.0;
array_configs(cfg_idx).is_sparse = true;

cfg_idx = cfg_idx + 1;
array_configs(cfg_idx).name = 'URA-1.5λ';
array_configs(cfg_idx).create_func = @() create_sparse_ura(3, 3, lambda * 1.5);
array_configs(cfg_idx).description = 'URA(1.5λ间距,3×3=9元)';
array_configs(cfg_idx).spacing_ratio = 3.0;
array_configs(cfg_idx).is_sparse = true;
